...
d = draw.Drawing(200, 100, origin='center', transform='scale(4)',  displayInline=False)

# Draw an irregular polygon
lines = draw.Lines(-80, -45,
                    70, -49,
                    95, 49,
                    -90, 40,
                    close=False,
...
# Draw a rectangle
for i in range(1,10):
    r = draw.Rectangle(0,0,40,40, fill='#12{}ff'.format(str(i*10)),
                       transform='rotate({} 20 -20) '.format(str(i*10)),
                       )
